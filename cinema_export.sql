...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "CINEMA"."CUSTOMERS_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL
--------------------------------------------------------
--  DDL for Sequence ROOMS_SEQ
--------------------------------------------------------

   CREATE SEQUENCE  "CINEMA"."ROOMS_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE TABLE "CINEMA"."CUSTOMERS" 
   (	"ID" NUMBER(5,0) GENERATED ALWAYS AS IDENTITY MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE , 
	"EMAIL" VARCHAR2(50) COLLATE "USING_NLS_COMP"
...
--------------------------------------------------------
  ...
  CREATE TABLE "CINEMA"."DISCOUNTS" 
   (	"ID" CHAR(5) COLLATE "USING_NLS_COMP", 
...
--------------------------------------------------------
  ...
  CREATE TABLE "CINEMA"."ROOMS" 
   (	"ID" NUMBER(3,0) GENERATED BY DEFAULT AS IDENTITY MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE , 
	"CAPACITY" NUMBER(3,0), 
	"SCREENING_TYPE" CHAR(4) COLLATE "USING_NLS_COMP"
   )  DEFAULT COLLATION "USING_NLS_COMP"
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE TABLE "CINEMA"."SCREENING_TYPES" 
   (	"ID" CHAR(4) COLLATE "USING_NLS_COMP", 
	"TYPE_NAME" NVARCHAR2(20) COLLATE "USING_NLS_COMP", 
	"PRICE" NUMBER(3,0)
   )  DEFAULT COLLATION "USING_NLS_COMP" 
...
--------------------------------------------------------
  ...
  CREATE TABLE "CINEMA"."SOLD_TICKETS" 
   (	"ID" NUMBER(6,0) GENERATED ALWAYS AS IDENTITY MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE , 
	...
	"DISCOUNT_ID" CHAR(5) COLLATE "USING_NLS_COMP", 
	"TICKET_ORDER_TIME" TIMESTAMP (3)
   )  DEFAULT COLLATION "USING_NLS_COMP"
REM INSERTING into CINEMA.CUSTOMERS
SET DEFINE OFF;
REM INSERTING into CINEMA.DISCOUNTS
SET DEFINE OFF;
REM INSERTING into CINEMA.FILMS
SET DEFINE OFF;
REM INSERTING into CINEMA.ROOMS
SET DEFINE OFF;
REM INSERTING into CINEMA.SCREENINGS
SET DEFINE OFF;
REM INSERTING into CINEMA.SCREENING_TYPES
SET DEFINE OFF;
REM INSERTING into CINEMA.SOLD_TICKETS
SET DEFINE OFF;
--------------------------------------------------------
